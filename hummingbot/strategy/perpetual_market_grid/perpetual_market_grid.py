...
class PerpetualMarketGridStrategy(StrategyPyBase):
    ...
    def tick(self, timestamp: float):
        self.logger().info(f"ceiling {self._price_ceiling}" f"floor {self._price_floor}" f"levels {self._order_levels}" f"interval {self._grid_interval}")
