...
from hummingbot.strategy.perpetual_market_grid import (
    PerpetualMarketGridStrategy,
)
from hummingbot.strategy.perpetual_market_grid.perpetual_market_grid_config_map import perpetual_market_grid_config_map as c_map
...
def start(self):
    try:
        ...
        strategy_logging_options = PerpetualMarketGridStrategy.OPTION_LOG_ALL
